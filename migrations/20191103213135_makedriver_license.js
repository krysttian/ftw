...
exports.up = function(knex) {
      return knex.schema.createTable('driver_license', function (table) {
        ...
        table.enu('county', null, { useNative: true, existingType: true, enumName: 'florida_counties', schemaName: 'public' }).notNullable().comment('This is the list of supported counties');
