...
exports.up = async function(knex) {
      await knex.schema.createTable('launch_subscriber', function (table) {
        ...
        table.enu('county', null, { existingType: true, useNative: true, enumName: 'florida_counties', schemaName:'public' }).notNullable().comment('This is the list of supported counties');
