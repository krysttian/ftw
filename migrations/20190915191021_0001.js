...
exports.up = async function(knex) {
      await knex.schema.createTable('launch_subscriber', function (table) {
        ...
        table.enu('county', ['MIAMI-DADE', 'BROWARD', 'PALM-BEACH', 'ORANGE'], { useNative: true, enumName: 'county', schemaName:'ftwschema' }).notNullable().comment('This is the list of supported counties');
